...
class TestPyLDDataAdapter:
    ...
    def test_typed_value_normalization(self):
        ...
        test_cases = [
            # Float values
            ([{"@value": "10.5", "@type": "http://www.w3.org/2001/XMLSchema#float"}], 10.5),
            ([{"@value": "3.14159", "@type": "http://www.w3.org/2001/XMLSchema#double"}], 3.14159),
            ([{"@value": "2.71828", "@type": "http://www.w3.org/2001/XMLSchema#decimal"}], 2.71828),
            
            # Integer values  
            ([{"@value": "42", "@type": "http://www.w3.org/2001/XMLSchema#integer"}], 42),
            ([{"@value": "100", "@type": "http://www.w3.org/2001/XMLSchema#int"}], 100),
            ([{"@value": "999", "@type": "http://www.w3.org/2001/XMLSchema#long"}], 999),
            
            # Boolean values
            ([{"@value": "true", "@type": "http://www.w3.org/2001/XMLSchema#boolean"}], True),
            ([{"@value": "false", "@type": "http://www.w3.org/2001/XMLSchema#boolean"}], False),
            ([{"@value": "1", "@type": "http://www.w3.org/2001/XMLSchema#boolean"}], True),
            
            # String values
            ([{"@value": "hello", "@type": "http://www.w3.org/2001/XMLSchema#string"}], "hello"),
        ]
    ...
    def test_complex_nested_structure(self):
        ...
        pyld_complex = {
            ...
            "metadata": {
                ...
                "created": [{"@value": "2023-01-01", "@type": "http://www.w3.org/2001/XMLSchema#string"}]
            }
        }
...
class TestEdgeCases:
    ...
    def test_boolean_string_variations(self):
        ...
        for input_str, expected in boolean_cases:
            pyld_bool = [{"@value": input_str, "@type": "http://www.w3.org/2001/XMLSchema#boolean"}]
