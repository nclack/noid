...
from noid_transforms.models import (
    ...
    DisplacementLookupTable, CoordinateLookupTable, SamplerConfig
)
...
class TestCoordinateLookupTable:
    ...
    def test_to_dict(self):
        ...
        assert "lookup_table" in result
        assert result["lookup_table"]["path"] == "path/to/lut.zarr"
        assert result["lookup_table"]["interpolation"] == "cubic"
