...
def jsonld_examples():
    """Demonstrate JSON-LD specific features."""
    ...
    context = transforms.export_schema_context()
    print("Schema context keys:", list(context.keys()))
    print()
    ...
    print(f"Round-trip successful: {recreated.to_dict() == translation.to_dict()}")
    print()
